...
public class VendorQuery {
    ...
    public static final String UpdateVendor = "update vendor set name = ? ,password = ?, start_time = ?, end_time = ?, status = ? where id = ? ;";

    public static final String DeleteVendor = "update vendor set status=0 where id = ?;";

    public static final String UpdateVendorStatus = "update vendor set status=? where id = ?;";
    ...
    public static final String GetAllVendors = "select v.id,v.role_id,v.business_id,v.name,v.shop_name, v.email,v.mobile,v.location,v.start_time default_start_time,v.end_time default_end_time,v.status,\n" +
    ...
    public static final String CreateChargerType = "insert into charger_type (vendor_id, charger_type,status) values (?,?,?);";

    public static final String UpdateChargerType = "update charger_type set charger_type = ?, status = ?  where id = ? ;";
